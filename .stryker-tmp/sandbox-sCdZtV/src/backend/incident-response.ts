...
export function triggerPlaybook(event: any) {
  if (stryMutAct_9fa48("137")) {
    ...
    console.log(stryMutAct_9fa48("138") ? "" : (stryCov_9fa48("138"), '[INCIDENT RESPONSE] Playbook triggered for event:'), event);
  }
}

// CommonJS compatibility for Jest tests
module.exports = stryMutAct_9fa48("139") ? {} : (stryCov_9fa48("139"), {
  triggerPlaybook
});
...
exports.playKeno = playKeno;
exports.playHiLo = playHiLo;
exports.playWheel = playWheel;
exports.playTower = playTower;
exports.playVideoPoker = playVideoPoker;
const SUIT_LIST = ['♠', '♥', '♦', '♣'];
...
function playKeno() {
    ...
    const table = { 0: '0x', 1: '0x', 2: '0.5x', 3: '1x', 4: '3x', 5: '10x', 6: '50x', 7: '200x', 8: '1000x' };
...
function playVideoPoker() {
    ...
    const rankIdx = (c) => RANK_LIST.indexOf(c.rank);
